...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1b3fbeef0f858089a535c274c18b5178',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hima', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'An effective thinker🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.recordspace.icu/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Knowledge, Thinking, Blog, Record Space, Senu', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/HimasWorld/RecordSpace/refs/heads/main/conf/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://www.recordspace.icu/', // 备案查询链接，如果用了萌备等备案请在这里填写
  ...
  GREETING_WORDS:
    ...
    'Hi，welcome to my thinking site, Hi，this is Hemal, Hi，this site is used to execute an effective thinking, Hi great thinking comes from small things🎉',
